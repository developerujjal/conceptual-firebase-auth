            ...
            <div className="relative -mt-40 m-4">
                <form
                    ...
                    <div className="mt-8">
                        ...
                        <div className="relative flex items-center">
                            <input name="email" type="email" required className="w-full bg-transparent text-sm text-gray-800 border-b border-gray-300 focus:border-blue-500 px-2 py-3 outline-none" placeholder="Enter email" />
                    ...
                    <div className="flex items-center mt-8">
                        ...
                        <label htmlFor="remember-me" className="ml-3 block text-sm">
                            I accept the <a className="text-blue-500 font-semibold hover:underline ml-1">Terms and Conditions</a>
                        </label>
                    </div>
                    ...
                    <div className="mt-8">
                        ...
                        <p className="text-gray-800 text-sm mt-8 text-center">Already have an account? <a className="text-blue-500 font-semibold hover:underline ml-1">Login here</a></p>
                    </div>
                </form>
            </div>
        </div>
